...
const Navigation = ({ item }) => {
  ...
  return (
    <div className="text-white  index" style={{ position: "relative" }}>
      <Headroom>
        <Navbar bg="black" variant="dark" expand="lg">
          <Container>
            <Nav.Link className="hover text-white" as={Link} to="/home">
              Home
            </Nav.Link>
            ...
            <Navbar.Collapse id="navbarScroll">
              ...
              <Nav.Link className=" text-white " as={Link} to="/cart">
                <div className=" position-relative">
                  Cart
                  <i class="fa-thin fa-cart-shopping text-white"></i>
